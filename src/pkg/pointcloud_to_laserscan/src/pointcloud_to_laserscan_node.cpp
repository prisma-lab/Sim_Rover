...
{
  target_frame_ = this->declare_parameter("target_frame", "rover/lidar_link");
  ...
  pub_ = this->create_publisher<sensor_msgs::msg::LaserScan>("converted_scan", rclcpp::SensorDataQoS());
