...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rover_camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '424,240,30', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '424,240,30', 'description': 'depth stream profile'},
