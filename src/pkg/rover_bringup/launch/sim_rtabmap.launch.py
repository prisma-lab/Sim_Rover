...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('Grid/FlatObstacleDetectedAngle', default_value='"15"', description=''),
        DeclareLaunchArgument('Grid/MaxGroundAngle', default_value='"20"', description=''),
