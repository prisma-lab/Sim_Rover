...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        DeclareLaunchArgument('depth', default_value=ConditionalText('true', 'false', IfCondition(PythonExpression(["'", LaunchConfiguration('stereo'), "' == 'true'"]))._predicate_func(context)), description=''),
        ...
        DeclareLaunchArgument('Grid/RangeMax', default_value='"5.0"', description=''),
        DeclareLaunchArgument('Grid/RangeMin', default_value='"0.3"', description=''),
        DeclareLaunchArgument('Grid/MaxObstacleHeight', default_value='"1.0"', description=''),
        DeclareLaunchArgument('Grid/CellSize', default_value='"0.05"', description=''),
        DeclareLaunchArgument('Grid/NoiseFilteringMinNeighbors', default_value='"5"', description=''),
        DeclareLaunchArgument('Grid/NoiseFilteringRadius', default_value='"0.03"', description=''),
        DeclareLaunchArgument('Grid/NormalsSegmentation', default_value='"true"', description=''),
        DeclareLaunchArgument('GridGlobal/UpdateError', default_value='"0.6"', description=''), 
        DeclareLaunchArgument('GridGlobal/Eroded', default_value='"true"', description=''),
        DeclareLaunchArgument('GridGlobal/ProbMiss', default_value='"0.2"', description=''), 
        DeclareLaunchArgument('Grid/Scan2dUnknownSpaceFilled', default_value='"true"', description=''),  
        DeclareLaunchArgument('GridGlobal/OccupancyThr', default_value='"0.5"', description=''),
        DeclareLaunchArgument('Grid/FootprintLength', default_value='"0.5"', description=''),
        DeclareLaunchArgument('Grid/FootprintWidth', default_value='"0.5"', description=''),
        DeclareLaunchArgument('Grid/FootprintHeight', default_value='"0.3"', description=''),
        DeclareLaunchArgument('GridGlobal/FootprintRadius', default_value='"0.25"', description=''),
        DeclareLaunchArgument('scan_cloud_max_points', default_value='1000', description=''),
        DeclareLaunchArgument('DetectionRate', default_value='"5.0"', description=''),
        ...
        DeclareLaunchArgument('GridGlobal/FullUpdate', default_value='"true"', description=''),
        DeclareLaunchArgument('MapUpdateRate', default_value='"5.0"', description=''),
        DeclareLaunchArgument('GridGlobal/OccupancyThr', default_value="'0.7'", description=''),
        DeclareLaunchArgument('GridGlobal/UpdateError', default_value='"0.5"', description=''),
        DeclareLaunchArgument('Grid/FlatObstacleDetectedAngle', default_value='"25"', description=''),
        DeclareLaunchArgument('Grid/MaxGroundAngle', default_value='"22"', description=''),
        ...
        Node(
            ...
            parameters=[{
                ...
                "Grid/MaxObstacleHeight": LaunchConfiguration('Grid/MaxObstacleHeight'),
                # "Grid/CellSize": LaunchConfiguration('Grid/CellSize'), 
                #"Grid/NoiseFilteringMinNeighbors": LaunchConfiguration('Grid/NoiseFilteringMinNeighbors'), 
                #"Grid/NoiseFilteringRadius": LaunchConfiguration('Grid/NoiseFilteringRadius'),
                #"Grid/FootprintLength": LaunchConfiguration('Grid/FootprintLength'), 
                #"Grid/FootprintWidth": LaunchConfiguration('Grid/FootprintWidth'),
                #"Grid/FootprintHeight" : LaunchConfiguration('Grid/FootprintHeight'),
                "GridGlobal/FootprintRadius": LaunchConfiguration('GridGlobal/FootprintRadius'),  
                #"Grid/NormalsSegmentation": LaunchConfiguration('Grid/NormalsSegmentation'),
                #"GridGlobal/OccupancyThr": LaunchConfiguration('GridGlobal/OccupancyThr'),                 
                "GridGlobal/UpdateError": LaunchConfiguration('GridGlobal/UpdateError'), 
                #"GridGlobal/Eroded": LaunchConfiguration('GridGlobal/Eroded'),
                #"GridGlobal/ProbMiss": LaunchConfiguration('GridGlobal/ProbMiss'), 
                #"Grid/Scan2dUnknownSpaceFilled": LaunchConfiguration('Grid/Scan2dUnknownSpaceFilled'),
                "scan_cloud_max_points": LaunchConfiguration('scan_cloud_max_points'), 
                "DetectionRate" : LaunchConfiguration('DetectionRate'),
                #"Grid/MaxGroundHeight" : LaunchConfiguration('Grid/MaxGroundHeight'),
                # "LoopClosureDetection" : LaunchConfiguration('LoopClosureDetection'),
                #"StartNewMapOnLoopClosure" : LaunchConfiguration('StartNewMapOnLoopClosure'),
                "Grid/RayTracing" : LaunchConfiguration('Grid/RayTracing'),
                # "LoopThr" : LaunchConfiguration('LoopThr'),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='rover/base_footprint',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        DeclareLaunchArgument('odom_frame_id',  default_value='rover/odom',                   description='If set, TF is used to get odometry instead of the topic.'),
        DeclareLaunchArgument('map_frame_id',   default_value='rover/map',                description='Output map frame id (TF).'),
        ...
        DeclareLaunchArgument('depth_topic',         default_value='/depth/image_raw/points', description=''),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='/depth/image_raw', description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/odom/wheels',  description='Odometry topic name.'),
