...
|odom_tf_name| string | Name of the odom frame
|base_tf_name| string | Name of the base frame of the diff drive 
|use_runge_kutta | bool | If true, use Runge-Kutta 2 order integration, otherwise use Forward Euler
